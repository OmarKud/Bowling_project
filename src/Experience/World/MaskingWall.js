...
export default class MaskingWall {
  ...
  build() {
    ...
    new CustomBox(
      ...
      wallHeight,
      1.5,
      this.maskWallMaterial,
      new THREE.Vector3(0, wallY, -230),
    );
    ...
    new CustomBox(
      ...
      pitDepth,
      this.maskWallMaterial,
      new THREE.Vector3(-(lanesClusterWidth / 2), fullHeightY, pitCenterZ),
    );
    new CustomBox(
      this.container,
      1.5,
    ...
    for (let i = 1; i < this.totalLanes; i++) {
      const xDividerPos =
        startX - this.laneComponentWidth / 2 + i * this.laneComponentWidth;
      new CustomBox(
        this.container,
        1.0,
        14,
        pitDepth,
        this.partitionMaterial,
        new THREE.Vector3(xDividerPos, 7, pitCenterZ),
      );
    }
  }
}
