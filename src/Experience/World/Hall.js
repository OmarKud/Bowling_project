...
export default class Hall {
  constructor() {
    ...
    this.bowlingScreens = new BowlingScreens(
      this.container,
      this.screenFrameMaterial,
    );
    this.ballReturnSystem = new BallReturnSystem(
      this.container,
      this.ballReturnMaterial,
      this.pillarMaterial,
    );
  ...
  setMaterials() {
    ...
    this.floorTexture = this.textureLoader.load(
      "/textures/bowling_wood_lane.jpg",
    );
  ...
  buildHallWalls() {
    ...
    new CustomBox(
      ...
      52,
      540,
      this.lightWallMaterial,
      new THREE.Vector3(-130, 26, 0),
    );
    new CustomBox(
      this.container,
      0.2,
  ...
  buildFrontWallAndGlassDoor() {
    ...
    new CustomBox(
      ...
      0.2,
      this.lightWallMaterial,
      new THREE.Vector3(leftWallX, wallHeight / 2, wallZ),
    );
    new CustomBox(
      this.container,
      sideWallWidth,
      ...
      0.2,
      this.lightWallMaterial,
      new THREE.Vector3(rightWallX, wallHeight / 2, wallZ),
    );
    ...
    new CustomBox(
      ...
      0.2,
      this.lightWallMaterial,
      new THREE.Vector3(0, topWallY, wallZ),
    );
    ...
    new CustomBox(
      ...
      new THREE.Vector3(0, this.doorHeight, wallZ),
    );
    new CustomBox(
      this.container,
      0.4,
      ...
      0.6,
      this.doorFrameMaterial,
      new THREE.Vector3(-(this.doorWidth / 2), this.doorHeight / 2, wallZ),
    );
    new CustomBox(
      this.container,
      0.4,
    ...
    this.leftDoorGroup.position.set(
      this.leftDoorCurrentX,
      leafHeight / 2,
      wallZ,
    );
    new CustomBox(
    ...
    new CustomBox(
      ...
      0.4,
      this.doorFrameMaterial,
      new THREE.Vector3(0, leafHeight / 2, 0),
    );
    new CustomBox(
      this.leftDoorGroup,
      leafWidth,
    ...
    this.rightDoorGroup.position.set(
      this.rightDoorCurrentX,
      leafHeight / 2,
      wallZ,
    );
    new CustomBox(
  ...
  buildWallPillars() {
    ...
    for (let i = 0; i < totalPillars; i++) {
      ...
      new CustomBox(
        ...
        4,
        this.pillarMaterial,
        new THREE.Vector3(-129.2, 26, zPos),
      );
      new CustomBox(
        this.container,
        1.5,
  ...
  buildZigZagNeon() {
    ...
    for (let i = 0; i < totalSegments; i++) {
      ...
      const rotLeft = new THREE.Euler(
        isEven ? Math.PI * 0.05 : -Math.PI * 0.05,
        0,
        0,
      );
      const rotRight = new THREE.Euler(
        isEven ? -Math.PI * 0.05 : Math.PI * 0.05,
        0,
        0,
      );
      ...
      new CustomBox(
        ...
        0.3,
        segmentLength,
        this.cyanNeonMaterial,
        new THREE.Vector3(-128.3, isEven ? 24 : 16, currentZ),
        rotLeft,
      );
      new CustomBox(
        this.container,
        ...
        0.3,
        segmentLength,
        this.magentaNeonMaterial,
        new THREE.Vector3(-128.3, isEven ? 16 : 8, currentZ),
        rotLeft,
      );
      new CustomBox(
        this.container,
  ...
  buildFourDroppedCeilings() {
    ...
    for (let i = 0; i < totalCeilings; i++) {
      ...
      new CustomBox(
        ...
        0.2,
        ceilingDepth,
        this.bottomCeilingMaterial,
        new THREE.Vector3(xPos, dropY, centerZ),
      );
      new CustomBox(
        this.container,
        0.2,
        ...
        ceilingDepth,
        this.edgeMaterial,
        new THREE.Vector3(xPos - ceilingWidth * 0.5, dropY + 0.75, centerZ),
      );
      new CustomBox(
        this.container,
        0.2,
      ...
      new CustomBox(
        ...
        0.2,
        this.edgeMaterial,
        new THREE.Vector3(xPos, dropY + 0.75, frontEdgeZ),
      );

      const blockNeonMaterial =
        i % 2 === 0 ? this.cyanNeonMaterial : this.magentaNeonMaterial;
      ...
      new CustomBox(
        ...
        0.2,
        blockNeonMaterial,
        new THREE.Vector3(xPos, dropY + 1.4, frontEdgeZ),
      );
      ...
      new CustomBox(
        ...
        slantLength,
        this.edgeMaterial,
        new THREE.Vector3(-(ceilingWidth * 0.5), 0.75, localZ),
      );
      new CustomBox(
        slantGroup,
        0.2,
      ...
      new CustomBox(
        ...
        0.2,
        this.edgeMaterial,
        new THREE.Vector3(0, 0.75, -slantLength),
      );
      ...
      new CustomBox(
        ...
        slantLength,
        blockNeonMaterial,
        new THREE.Vector3(-(ceilingWidth * 0.5) - 0.1, 1.4, localZ),
      );
      new CustomBox(
        slantGroup,
        0.1,
      ...
      new CustomBox(
        ...
        0.2,
        blockNeonMaterial,
        new THREE.Vector3(0, 1.4, -slantLength + 0.25),
      );
    ...
    for (let i = 0; i < totalGridX; i++) {
      ...
      for (let j = 0; j < totalGridZ; j++) {
        ...
        new CustomBox(
          ...
          12,
          this.edgeMaterial,
          new THREE.Vector3(xPos, 51.9, zPos),
        );
        new CustomBox(
          this.container,
          10,
          0.12,
          10,
          this.gridNeonMaterial,
          new THREE.Vector3(xPos, 51.88, zPos),
        );
      }
    }
  }
  ...
  update() {
    ...
    this.leftDoorCurrentX +=
      (this.leftDoorTargetX - this.leftDoorCurrentX) * 0.12;
    this.rightDoorCurrentX +=
      (this.rightDoorTargetX - this.rightDoorCurrentX) * 0.12;
