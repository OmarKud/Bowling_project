...
export default {
    ...
    initializeSimulation(settings, _ballMesh, _pinsMeshes) {
        ...
        console.log(`Ball Launch | v0: ${v0.toFixed(2)} m/s | angle: ${settings.launchAngle} deg | startY: ${startPosPhysics.y.toFixed(3)} m | radius: ${radius.toFixed(3)} m`);
    ...
    _endSimulation(isGutterBall = false) {
        ...
        setTimeout(() => {
            this.experience.world?.hall?.bowlingScreens?.showResultForLane?.(this.currentLaneIndex, resultPayload);
